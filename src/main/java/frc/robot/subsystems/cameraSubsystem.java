...
public class cameraSubsystem extends SubsystemBase{
    ...
    new Thread(
        () -> {
          ...
          AprilTagPoseEstimator.Config PestConfig = new AprilTagPoseEstimator.Config(0.1524,680,680,680,680);
          ...
          while (!Thread.interrupted()) {
            ...
            for (var result: results) {
              ...
              Imgproc.putText(mat,String.valueOf(position.getZ()), pt1, Imgproc.FONT_HERSHEY_SIMPLEX, 2, green, 7);
              ...
              SmartDashboard.putNumber("Tag Degrees", tagRotation2d.getRadians() * 360);
            }
...
public void periodic(){
    //position = poseEst.estimateHomography(result); // 1 frame is 0.73
}
